...
def compute_score(
    ...
    """
    from verl.utils.reward_score import math_grader
    try:
        res = math_grader.boxed_reward_fn_timeout(solution_str, ground_truth)
    except:
        print("timeout!!!")
        res = {"score": -1, "acc": False, "pred": "[INVALID]", "right_brace_idx": 0}
